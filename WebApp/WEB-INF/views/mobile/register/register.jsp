...
<script>
	...
	$(function(){		
		...
		$("#btn_register").click(function(){
			...
			var recommoned = $("#recommonedPhone").val();
			...
			var dto = {
				...
				code:phoneAuthCode,
				password:password,
				recommonedPhone:recommoned,				
				nickname:nickname
			}
			
			$.post("${ctx}/weixin/register/register",dto,function(data){
				if(data.code==0){
    ...
    <div class="erwei"><img src="${ctx }/static/brd-mobile/images/bjer.png"></div>
        ...
        <form id="form_submit" >
         ...
         <p>
          ...
          <p><input type="text" placeholder="填写推荐码即送88元红包" id="recommonedPhone" class="e_do"></p>
