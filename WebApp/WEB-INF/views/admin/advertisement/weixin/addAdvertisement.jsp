...
<script type="text/javascript">
	$(function() {
		...
		$("#ipt_addBanner").click(function() {			
			...
			$.post("${ctx}/admin/advertisement/weixin/ad/addAdvertisement",
...
<body>
	<div class="basic">
        <p>广告管理</p>
        <span><a href="<c:url value='/admin/main'/>"  style="margin-left:0;">首页</a>><a href="#" >广告管理</a>><a href="#" >微信站</a>><a><strong>新增滚播图</strong></a></span>
    </div>	
