...
<script type="text/javascript">
	$(function() {
		...
		$("samp").click(function(){
			location.href="${ctx}/admin/advertisement/weixin/ad/toAddAdvertise" ;
		});
	...
	function delAd(id){
		showCallBackDialog("是否确定删除该条滚播图?",function(){
			$.post("${ctx}/admin/advertisement/weixin/ad/delAd",{id:id},function(data){
				if(data.code==0){
...
<body>
	...
	<div class="basic">
        <p>广告管理</p>
        <span><a href="<c:url value='/admin/main'/>"  style="margin-left:0;">首页</a>><a href="#" >广告管理</a>><a><strong>微信站</strong></a></span>
    </div>	
	
	<div class="employee animated fadeInRight e_cut n_mar">
           <dl>
           	<dt style="width:0;"></dt>
                     ...
                     <c:forEach var="advertisement" items="${page.getContent() }">
                     	<tr >
							...
							<c:otherwise>
                     		...
                     		<td>
	                            <div class="level_img">
	                                <span><a href="${ctx }/admin/advertisement/weixin/ad/toEditAd/${advertisement.id}" ><img src="${ctx}/static/brd/img/bjt1.png"></a></span>
	                               	<c:if test="${advertisement.position ne 'FINANCMANAGER' }" >
