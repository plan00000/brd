...
<script type="text/javascript">
	$(function() {
		...
		$("#ipt_addBanner").click(function() {
			...
			$.post("${ctx}/admin/advertisement/pc/ad/editAdvertisement",
...
<body>
		<div class="basic">
        <p>广告管理</p>
        <span><a href="<c:url value='/admin/main'/>"  style="margin-left:0;">首页</a>><a href="#" >广告管理</a>><a href="#" >PC官网</a>><a><strong>编辑图片</strong></a></span>
    </div>	
