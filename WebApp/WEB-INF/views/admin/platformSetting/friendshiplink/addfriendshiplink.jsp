...
<script type="text/javascript">
	$(function(){
		...
		$("#submit").click(function(){
			...
			$.post("${ctx}/admin/platformSetting/friendshiplink/addEditFriendship",{title:title,linkUrl:linkUrl},function(data){
				if(data.code==0){
	  	...
	  	<div class="new_xinxi"><p><font>新增链接</font></p></div>
	    	<form id="myform" >
		    	<div class="connection">
			        	<dl>
			                <dt>链接名称：</dt>
			                <dd><input type="text" maxlength="10" id="title" name="title" class="c_net" 
			                onKeyDown="gbcount(this.form.title,this.form.userd2,10);"  onKeyUp="gbcount(this.form.title,this.form.userd2,10);" >
			                   	<input style="margin-left:5px;width: 40px;height:30px;border:none;background:#fff;" name="userd2" value="0/10" readonly="readonly" /></dd>
			            </dl>
			            <dl>
			                <dt>链接地址：</dt>
