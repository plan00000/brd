...
<div class="row  border-bottom">
	<div class="basic">
        <p>新增司机</p>
        <span><a href="<c:url value='/admin/main'/>"  style="margin-left:0;">首页</a>><a href="#" >司机管理</a>><a><strong>新增司机</strong></a></span>
    </div>
    </div>
	            ...
	            <div class="new_text">
					...
					<div class="new_batt" >
	                 ...
	                 <dl>
						...
						<dl>
							<dt>身份证号：</dt>
							<dd><input type="text" name="idCard" id="idCard" maxlength="11"  class="n_la" ></dd>
						</dl>
						<dl>
							<dt>车牌号：</dt>
	                ...
	                <div >
						...
						<dl>
							<dt>车辆型号：</dt>
							<dd><input type="text" name="carMark" id="carMark" maxlength="11"  class="n_la" ></dd>
						</dl>
						<dl>
							<dt>车辆颜色：</dt>
							<dd><input type="text" name="carColor" id="carColor" maxlength="11"  class="n_la" ></dd>
						</dl>
	            </div>
	            </div>
            </form>
