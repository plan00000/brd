	...
	$(function() {
		...
		$("#submit").click(function(){
			var content =  detailEditor.getContentTxt();
			 $.post("${ctx}/admin/information/apprentice/modify",$("#myform").serialize(),function(data){
				if(data.code==0){
					showCallBackDialog("修改成功",function() {
						location.href = "${ctx}/admin/information/apprentice";
						})
				}else{
					alert(data.mes);
				}
...
<div class="row  border-bottom">
	<div class="basic">
        <p>官网文章</p>
        <span><a href="<c:url value='/admin/main'/>"  style="margin-left:0;">首页</a>><a href="#" >官网文章</a>><a><strong>收徒指南</strong></a></span>
    </div>
    </div>
	<div class="row">
			<div class="col-lg-12">
