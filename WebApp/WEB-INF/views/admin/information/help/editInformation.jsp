...
var detailEditor;
	$(function() {
		...
		$("#backPage").click(function(){
			...
			location.href="${ctx}/admin/information/help/list?sortType=${sortType}&page=${page}";
		})
		...
		$("#submit").click(function(){
			...
			var content =  detailEditor.getContentTxt();
			 ...
			 $.post("${ctx}/admin/information/help/editActivityInformation",$("#myform").serialize(),function(data){
				if(data.code==0){
...
<div class="row  border-bottom">
		<div class="basic">
        <p>文章管理</p>
        <span><a href="<c:url value='/admin/main'/>"  style="margin-left:0;">首页</a>><a href="#" >文章管理</a>><a href="#" >帮助中心</a>><a><strong>编辑帮助中心</strong></a></span>
   		 </div>
	</div>
