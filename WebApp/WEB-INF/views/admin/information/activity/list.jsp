...
<script type="text/javascript">
	$(function() {
		...
		$("#deleteInformation").click(function(){
			...
			showCallBackDialog("确定删除?",function(){
				$.post("${ctx}/admin/information/activity/delInformations",{ids:ids},function(data){
					if(data.code==0){
						showCallBackDialog("删除成功",function(){
							location.href = "${ctx}/admin/information/activity/list";
						})
					}else{
						alert(data.mes);	
					}			
		...
		$("#addInformation").click(function(){
			location.href="${ctx}/admin/information/activity/toAddPage";
		});
	...
	function closeEdit(id){
		...
		$.post("${ctx}/admin/information/activity/changeSortid",{id:id,sortid:sortid},function(data){
			if(data.code==0){
				showCallBackDialog("修改成功",function(){
					location.href = "${ctx}/admin/information/activity/list?page=${pageNumber}&sortType=${sortType}";
				})
			}else{
				alert(data.mes);
			}
...
<div class="row  border-bottom">
	<div class="basic">
        <p>微信文章</p>
        <span><a href="<c:url value='/admin/main'/>"  style="margin-left:0;">首页</a>><a href="#" >微信文章</a>><a><strong>活动资讯</strong></a></span>
    </div>
</div>	
                 ...
                 <tbody>
                     ...
                     <c:forEach var="information" items="${page.getContent() }" >
                       <tr >
	                        ...
	                        <td>
	                        	<a href="${ctx}/admin/information/activity/toEditInformation/${information.id}?sortType=${sortType}&page=${page.getNumber() + 1}"  class="l_a"><img src="${ctx }/static/brd/img/bjt1.png"></a>
