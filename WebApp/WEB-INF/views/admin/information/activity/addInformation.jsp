	...
	$(function() {		
		...
		$("#submit").click(function(){
			...
			var content =  detailEditor.getContentTxt();
			 ...
			 $.post("${ctx}/admin/information/activity/addActivityInformation",$("#myform").serialize(),function(data){
				if(data.code==0){
...
<div class="row  border-bottom">
	<div class="basic">
        <p>微信文章</p>
        <span><a href="<c:url value='/admin/main'/>"  style="margin-left:0;">首页</a>><a href="#" >微信文章</a>><a href="#" >活动资讯</a>><a><strong>新增资讯</strong></a></span>
    </div>
	</div>
