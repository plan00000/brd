	...
	$(function() {		
		...
		$("#submit").click(function(){
			...
			if(summary.trim().length==0){
			 ...
			 $.post("${ctx}/admin/information/pcactivity/addActivityInformation",$("#myform").serialize(),function(data){
				if(data.code==0){
...
<div class="row  border-bottom">
	<div class="basic">
        <p>官网文章</p>
        <span><a href="<c:url value='/admin/main'/>"  style="margin-left:0;">首页</a>><a href="#" >官网文章</a>><a href="#" >精彩资讯</a>><a><strong>新增资讯</strong></a></span>
    </div>
	</div>
	<div class="username-text animated fadeInRight">
            <div class="reward">
                 ...
                 <dl>
                    <dt>资讯摘要：</dt>
                    <dd><textarea name="summary" id="summary" maxlength="500"  class="r_zixun"
                     onKeyDown="gbcount(this.form.summary,this.form.userd2,500);"  onKeyUp="gbcount(this.form.summary,this.form.userd2,500);" ></textarea>
                     <input style="border:none;background:#fff;margin-top:55px;margin-left:2px" name="userd2" value="0/500" readonly="readonly" />
                 ...
                 <p><samp id="submit" >新增</samp><samp class="r_bgjt" id="backPage" >返回</samp>
