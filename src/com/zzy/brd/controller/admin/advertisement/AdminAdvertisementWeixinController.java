 ...
 **/
@Controller
@RequestMapping(value="admin/advertisement/weixin")
public class AdminAdvertisementWeixinController {
	...
	private @Autowired UserService userService;
	 ...
	 public String list(
		 ...
		 searchParams.put("EQ_source", Advertisement.AdSourceType.WECHAT);
		 Advertisement manger = advertisementService.getAdvertisementByPositionAndType(Advertisement.AdPositionType.FINANCMANAGER,
				 Advertisement.AdSourceType.WECHAT);
		 if(manger==null){
				 manger = new Advertisement();
				 manger.setCreateTime(new Date());
				 manger.setIsouturl(IsOutUrl.NO);
				 manger.setPosition(Advertisement.AdPositionType.FINANCMANAGER);
				 manger.setSource(Advertisement.AdSourceType.WECHAT);
				 advertisementDao.save(manger);
		 }
		 Page<Advertisement> page = advertisementService.listAdvertisement(searchParams,pageNumber);
		 model.addAttribute("page", page);
		 return "/admin/advertisement/weixin/list";
	 }
	 ...
	 public RepSimpleMessageDTO addAdvertisement(@RequestParam(required=false)String picurl,Advertisement.AdPositionType position,boolean isouturl,String outurlAddress
		 ...
		 if(position.equals(AdPositionType.FINANCMANAGER)){
		 ...
		 //查询个数
		 List<Advertisement> countList = advertisementService.getAdvertisementByType(Advertisement.AdSourceType.WECHAT);
	 ...
	 public String toAddAdvertise() {
		 ...
		 return "/admin/advertisement/weixin/addAdvertisement";
	 }
	 ...
	 public @ResponseBody Map<String, Object> uploadImage(
			...
			while (itr.hasNext()) {
				...
				try {
					...
					image.setUrl(context+"/admin/advertisement/weixin/display?filePath="
	 ...
	 public String toEditAd(@PathVariable long advertisementId,Model model) {
		 ...
		 return "/admin/advertisement/weixin/editAdvertisement";
	 }
