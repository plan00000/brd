...
import com.zzy.util.ipseek.IPEntry;
...
//            LogFactory.log("",Level.ERROR,e);  
    ...
    private IPLocation getIPLocation(byte[] ip) {  
        ...
        if(info == null) {  
            info = new IPLocation();  
            info.setCountry (  IpMessage.unknown_country);  
            info.setArea(IpMessage.unknown_area);  
        }  
        return info;  
    }     
